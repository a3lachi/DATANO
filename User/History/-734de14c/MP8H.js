...
class App extends Component{
	...
	qsstiKanvaDown(event){
		...
		this.canvaCordX = event.pageX - 280*(7/12)
		this.canvaCordY = event.pageY - 102*(7/12)
	...
	qsstiKanvaMove(event){
		if (this.isCrop == 1) {
			...
			var width = event.pageX-this.canvaCordX-280*(7/12)
			var height = event.pageY-this.canvaCordY-102*(7/12)
