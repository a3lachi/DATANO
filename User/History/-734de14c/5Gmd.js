...
class App extends Component{
	...
	qsstiKanvaMove(event){
		if (this.isCrop == 1) {
			...
			var width = (event.pageX-this.canvaCordX-(window.innerWidth*(2/12)))*(this.mainImage.width/this.mainImage.height)
			var height = ((event.pageY-this.canvaCordY-102))*(this.mainImage.width/this.mainImage.height)
