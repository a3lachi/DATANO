...
class App extends Component{
	...
	qsstiKanvaDown(event){		
		...
		var finTrssm = document.getElementById('central');
		var canvas = document.createElement('canvas');
		canvas.setAttribute('id','crp'+this.nbCrop.toString())
		canvas.setAttribute('style','width: '+finTrssm.style.width+' ; height:'+finTrssm.style.height)
	...
	qsstiKanvaMove(event){
		if (this.isCrop == 1) {
			...
			console.log('vvvvvv ',canvas.width)
