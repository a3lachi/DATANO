...
class App extends Component{
	...
	qsstiKanvaDown(event){
		...
		this.canvaCordX = (event.pageX - (window.innerWidth*(2/12)))*(this.mainImage.width/this.mainImage.height)*(12/7)
		this.canvaCordY = (event.pageY - 102)*(this.mainImage.width/this.mainImage.height)*(12/7)
	...
	qsstiKanvaMove(event){
		if (this.isCrop == 1) {
			...
			var width = (event.pageX-this.canvaCordX-(window.innerWidth*(2/12)))*(this.mainImage.width/this.mainImage.height)*(12/7)
			var height = ((event.pageY-this.canvaCordY-102))*(this.mainImage.width/this.mainImage.height)*(12/7)
