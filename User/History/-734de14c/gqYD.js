...
class App extends Component{
	...
	qsstiKanvaDown(event){
		...
		this.canvaCordX = (event.pageX - (window.innerWidth*(2/12)))*(img.width/img.height)*(12/7)
		this.canvaCordY = (event.pageY - 102)*(img.width/img.height)*(12/7)
	...
	qsstiKanvaMove(event){
		if (this.isCrop == 1) {
			...
			console.log('DIMENSION dimage li 3liha rssmo ',img.width , img.height)
			var width = (event.pageX-this.canvaCordX-(window.innerWidth*(2/12)))*(img.width/img.height)*(12/7)
